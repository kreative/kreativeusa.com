...
export default function HackISUv2FeedbackForm() {
  return (
    <div>
      <NextSeo
        title="Provide feedback on DataISU v1"
        description="Help us make DataISU better for the world. Fill out our short feedback form to let us know what you think!"
      />
      <Navbar />
      <main>
        <Container>
