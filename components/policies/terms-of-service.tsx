  ...
  return (
    <main>
      <div className="text-md">
        <h2 className="font-chedros text-5xl font-bold tracking-tight pt-6">Terms and Conditions</h2>
        ...
        <p className="py-3">For the purposes of these Terms and Conditions:</p>
        <ul className="pl-3 list-disc space-y-3 py-6">
          ...
          <li>
            <p className="py-3">
              ...
              in this Agreement) refers to Kreative, LLC., 3012 Blazingstar
          ...
          <li>
            <p className="py-3">
              <strong>Website</strong> refers to Kreative, accessible from{" "}
              <a
        ...
        <h2 className="font-chedros text-4xl pt-6">Links to Other Websites</h2>
        <p className="py-3">
        ...
        <h2 className="font-chedros text-4xl pt-6">Limitation of Liability</h2>
        <p className="py-3">
        ...
        <h2 className="font-chedros text-4xl pt-6">Severability and Waiver</h2>
